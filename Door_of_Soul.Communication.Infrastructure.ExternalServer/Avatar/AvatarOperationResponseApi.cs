...
namespace Door_of_Soul.Communication.Infrastructure.ExternalServer.Avatar
{
    ...
    {
        public static void SendOperationResponse(Core.External.Device terminal, Core.Avatar target, AvatarOperationCode operationCode, OperationReturnCode operationReturnCode, string operationMessage, Dictionary<byte, object> parameters)
        {
