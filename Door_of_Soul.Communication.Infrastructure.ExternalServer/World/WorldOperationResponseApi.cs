...
namespace Door_of_Soul.Communication.Infrastructure.ExternalServer.World
{
    ...
    {
        public static void SendOperationResponse(Core.Device terminal, Core.World target, WorldOperationCode operationCode, OperationReturnCode operationReturnCode, string operationMessage, Dictionary<byte, object> parameters)
        {
