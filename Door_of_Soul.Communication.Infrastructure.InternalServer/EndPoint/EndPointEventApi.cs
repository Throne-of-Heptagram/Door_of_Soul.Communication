...
namespace Door_of_Soul.Communication.Infrastructure.InternalServer.EndPoint
{
    ...
    {
        public static void SendEvent(Core.Internal.EndPoint target, EndPointEventCode eventCode, Dictionary<byte, object> parameters)
        {
        ...
        public static void SystemEvent(SystemEventCode eventCode, Dictionary<byte, object> parameters)
        {
            ...
            foreach (var endPoint in CommunicationService.Instance.GetAllEndPoints())
            {
