...
namespace Door_of_Soul.Communication.Infrastructure.InternalServer.Answer
{
    ...
    {
        public static void SendOperationResponse(Core.Internal.EndPoint terminal, int deviceId, Core.Answer target, AnswerOperationCode operationCode, OperationReturnCode operationReturnCode, string operationMessage, Dictionary<byte, object> parameters)
        {
