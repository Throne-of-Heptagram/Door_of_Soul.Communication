...
{
    class EndPointAnswerOperationRequestBroker : OperationRequestHandler<TerminalEndPoint, EndPointOperationCode>
    {
        public EndPointAnswerOperationRequestBroker() : base(typeof(EndPointAnswerOperationRequestParameterCode))
        {
        }
        ...
        public override bool Handle(TerminalEndPoint terminal, EndPointOperationCode operationCode, Dictionary<byte, object> parameters, out string errorMessage)
        {
            ...
            {
                int answerId = (int)parameters[(byte)EndPointAnswerOperationRequestParameterCode.AnswerId];
                AnswerOperationCode resolvedOperationCode = (AnswerOperationCode)parameters[(byte)EndPointAnswerOperationRequestParameterCode.OperationCode];
                Dictionary<byte, object> resolvedParameters = (Dictionary<byte, object>)parameters[(byte)EndPointAnswerOperationRequestParameterCode.Parameters];
