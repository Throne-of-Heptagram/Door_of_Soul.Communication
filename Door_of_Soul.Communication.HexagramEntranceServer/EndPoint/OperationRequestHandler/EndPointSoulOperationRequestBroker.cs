...
{
    class EndPointSoulOperationRequestBroker : OperationRequestHandler<TerminalEndPoint, EndPointOperationCode>
    {
        public EndPointSoulOperationRequestBroker() : base(typeof(EndPointSoulOperationRequestParameterCode))
        {
        }
        ...
        public override bool Handle(TerminalEndPoint terminal, EndPointOperationCode operationCode, Dictionary<byte, object> parameters, out string errorMessage)
        {
            ...
            {
                int soulId = (int)parameters[(byte)EndPointSoulOperationRequestParameterCode.SoulId];
                SoulOperationCode resolvedOperationCode = (SoulOperationCode)parameters[(byte)EndPointSoulOperationRequestParameterCode.OperationCode];
                Dictionary<byte, object> resolvedParameters = (Dictionary<byte, object>)parameters[(byte)EndPointSoulOperationRequestParameterCode.Parameters];
                VirtualSoul soul;
