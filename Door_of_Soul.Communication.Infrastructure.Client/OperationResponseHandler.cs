...
namespace Door_of_Soul.Communication.Infrastructure.Client
{
    public abstract class OperationResponseHandler<TSubject, TOperationCode>
    {
        ...
        internal virtual bool Handle(TSubject subject, TOperationCode operationCode, OperationReturnCode returnCode, string operationMessage, Dictionary<byte, object> parameters, out string errorMessage)
        {
